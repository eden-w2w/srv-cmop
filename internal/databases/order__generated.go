...
func (m *Order) BatchFetchByStatusList(db github_com_eden_framework_sqlx.DBExecutor, values []github_com_eden_w2_w_srv_cmop_internal_contants_enums.OrderStatus) ([]Order, error) {
