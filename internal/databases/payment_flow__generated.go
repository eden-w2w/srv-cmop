...
import (
	...
	github_com_eden_w2_w_srv_cmop_internal_contants_enums "github.com/eden-w2w/srv-cmop/internal/contants/enums"
)
...
func (m *PaymentFlow) BatchFetchByStatusList(db github_com_eden_framework_sqlx.DBExecutor, values []github_com_eden_w2_w_srv_cmop_internal_contants_enums.PaymentStatus) ([]PaymentFlow, error) {
